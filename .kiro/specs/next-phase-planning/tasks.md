...
- [x] 3.2 (P) rune 対応の文字列操作関数（substring, indexOf）を実装する
...
- [x] 3.3 (P) 大文字・小文字変換関数（toUpper, toLower）を実装する
...
- [x] 4.2 (P) 可変長引数の数学関数（min, max）と 2 引数関数（pow）を実装する
...
- [x] 5.4 for-in ループの仕様ドキュメントを更新する
